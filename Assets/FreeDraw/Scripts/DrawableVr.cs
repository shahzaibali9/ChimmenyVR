...
public class DrawableVr : MonoBehaviour
{
...
[SerializeField] Camera renderCam;
    ...
    public static DrawableVr drawable;
    ...
    void Update()
    {
        ...
        Debug.Log("mouse is held down " + mouse_held_down);
        if (mouse_held_down && !no_drawing_on_current_drag)
        {
            // Convert mouse coordinates to world coordinates
            Vector2 mouse_world_position = renderCam.ScreenToWorldPoint(Input.mousePosition);
            Debug.DrawLine(mouse_world_position, Input.mousePosition , Color.red, 10f);
